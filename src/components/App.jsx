      ...
      <div className="page">
        <div className="page__container">
          ...
          <PopupWithForm name="edit_profile" title="редактировать профиль" submitText="Сохранить" isOpen={isEditProfilePopupOpen} onClose={closeAllPopups} children={
            <fieldset className="popup__contact-info">
              <div className="input-container">
                <input className="user-name" type="text" className="popup__input" value="" id="popup-edit-username" placeholder="Введите имя" autoComplete="off" required minLength="2" maxLength="40"/>
                <span className="error-message popup-edit-username-error">test</span>
              </div>
              <div className="input-container">
                <input name="user-job" type="text" className="popup__input" value="" id="popup-edit-job" autoComplete="off" placeholder="чем занимаетесь ?" required minLength="2" maxLength="200"/>
          ...
          <PopupWithForm name="add_picture" title="Новое место" submitText="Добавить" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups} children={
            <fieldset className="popup__contact-info">
              <div className="input-container">
                <input name="picture-name" type="text" className="popup__input" value="" id="popup-picture-name" autoComplete="off" placeholder="Название" required minLength="2" maxLength="30"/>
                <span className="error-message popup-picture-name-error">test</span>
              </div>
              <div className="input-container">
                <input name="picture-link" type="url" className="popup__input" value="" id="popup-picture-link" autoComplete="off" placeholder="Ссылка на картинку" required/>
          ...
          <PopupWithForm name="change_avatar" title="Обновить аватар" submitText="Сохранить" isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups} children={
            <fieldset className="popup__contact-info">
              <div className="input-container input-container_single">
                <input name="avatar-image" type="url" className="popup__input" value="" id="popup-change-avatar" autoComplete="off" placeholder="Ссылка на картинку" required/>
